                            ...
                            <form action="" class="" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="row" style="height: 100%; margin-right: 1px ;background:white">
                                            @csrf
                                    ...
                                    <div class="col-9">
                                        <div style="background: white;" class="row">
                                            ...
                                            <p></p>
                                            <h3 class="col-md-11 mb-3">Thông tin cá nhân</h3>
                                            <div class="col-md-1">
                                        ...
                                        <div style="background: white;" class="row">
                                            <p></p>
                                            <h3 class="col-md-11 mb-3">Thông tin liên hệ</h3>
