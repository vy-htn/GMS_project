...
<div style="background: gray;" class="right_col" role="main">
    ...
    <div class="row">
        ...
        <div class="col-3">
            ...
            <form action="" class="row" style="height: 100%; margin-right: 1px ;background:white">
                ...
                <div class="col-md-4">
                    <button type="button" class="btn btn-light"><i class="fa-regular fa-pen-to-square"></i></button>
                </div>
        ...
        <div class="col-9">
            <form style="background: white;" class="row">

                <h3 class="col-md-11">Thông tin liên hệ</h3>
                <div class="col-md-1">
                    <button type="button" class="btn btn-light"><i class="fa-regular fa-pen-to-square"></i></button>
                </div>
                <div class="col-md-6">
