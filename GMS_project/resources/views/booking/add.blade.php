    ...
    <form class="row g-3" method="POST" action="">
        <div class="x_content">
            <ul class="nav nav-tabs bar_tabs" role="tablist">
                <div class="container row overflow-hidden">
                    <div class="col-md-4">
                        <div class="p-3">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 row">
                            <h2 class="col-md-12">Đặt lịch hẹn</h2>
                        </div>
                    </div>

                    <div class="col-md-2">
                        <div class="p-3">
                            <button type="button" class="btn btn-primary">Xác nhận <i class="fa-solid fa-chevron-right"></i></button>
        ...
        <div class="card col-md-12" style="width: 18rem;">
            <div class="card-body row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="servicetype" aria-label="Default select example">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="car-body row">
                            ...
                            <div class="col-md-6">
                                <h3 class="card-title">Audi R8</h3>
                                <h6 class="card-subtitle mb-2 text-muted">2017</h6>
                                <p>23-DS.123331</p>

                                <div class="row dropdown">
                                    <div class="col-md-1"></div>
                                    <button class="col-md-8 btn-sm btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        Chọn xe
                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="#">Audi R8</a></li>
                                        <li><a class="dropdown-item" href="#">Mec GLC</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" placeholder="" id="inputNote" style="height: 100px"></textarea>
                </div>
            </div>
        </div>
